...
setwd("F:/National University of Singapore/Chong Kwek Yan - NSSF3/CRSF/Past projects - DO NOT SHARE/R_JJ/publish")
...
summary(chns)
#pdf("CN ratio.pdf", width=8, height=8)
par(mar=c(5,5,2,2))
boxplot(CN~Source, data=chns, ylab="C/N ratio", xlab="Plot type", las=1,
	lwd=2, cex=2, col=c("forestgreen", "steelblue"), cex.axis=1.5, cex.lab=2)
dev.off()
